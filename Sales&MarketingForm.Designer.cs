namespace C_Project
{
    partial class Sales_MarketingForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            label3 = new Label();
            QuotationNameber = new Label();
            label4 = new Label();
            QuotationNameberBox = new TextBox();
            label5 = new Label();
            CustomerContactBox = new TextBox();
            label6 = new Label();
            CustomerAddressButton = new Button();
            label7 = new Label();
            ...
            label12 = new Label();
            label13 = new Label();
            CustomerAddressBox = new ListBox();
            ...
            CustomerAddressButton.Text = "Click to edit";
            CustomerAddressButton.UseVisualStyleBackColor = true;
            // 
            // label7
            // 
            ...
            label13.Location = new Point(523, 89);
            ...
            // CustomerAddressBox
            // 
            CustomerAddressBox.FormattingEnabled = true;
            CustomerAddressBox.ItemHeight = 15;
            CustomerAddressBox.Location = new Point(523, 107);
            CustomerAddressBox.Name = "CustomerAddressBox";
            CustomerAddressBox.Size = new Size(271, 244);
            CustomerAddressBox.TabIndex = 31;
            // 
            // SaveButton
            // 
            SaveButton.Location = new Point(719, 357);
        ...
        private Label QuotationNameber;
        private Label label4;
        private TextBox QuotationNameberBox;
        private Label label5;
        private TextBox CustomerContactBox;
        ...
        private ListBox CustomerAddressBox;
